...
PICS = (environ.get('PICS', 'https://envs.sh/H7d.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6010754763').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '2318506882'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '2318506882').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', 'https://t.me/+0qcJxGQBFXIyMGRl') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', 'https://t.me/+0qcJxGQBFXIyMGRl')
...
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', 'thdhdgdjjvsskkl') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.
...
STREAM_MODE = bool(environ.get('STREAM_MODE', True)'https://t.me/+q_bHJfbaxBxlYmQ1') # Set True or False
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://prior-vonnie-ekzariamovie-9bf04da7.koyeb.app/")
